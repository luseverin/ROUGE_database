...
Impacts.register(
    key="DREF Allocation & Funding requirements",
    main_type="Economy & Culture",
    description="The DREF allocation or funding requirements for the event in CHF or other currency.",
    keyword=r"\b(DREF Allocation|Funding Requirements)\b",
...
IMPACT_SUBTYPES_MERGED = [
    el
    for el in IMPACT_SUBTYPES
    if el
    not in [
        "Road Infrastructure",
...
IMPACT_TYPES_MERGER = {
    "Transportation": "Infrastructure and Service access",
