        ...
        for precision_column in precision_columns_list:
            if precision_column in grouping_columns : 
                ...
                #Do not look at the exact value
                    ...
                    # Create binary vectors for the two lists
                    n_tmp = sum(1 for value in tmp_labelled_event_unique[precision_column] if (value != 'NULL') and (value != "missing"))
                    n_tmp2 = sum(1 for value in tmp_chat_event_unique[precision_column] if (value != 'NULL') and (value != "missing"))
            ...
            #Compare the list of unique informations found 
                ...
                n_tmp = sum(1 for value in tmp_labelled[precision_column] if (value != 'NULL') and (value != "missing"))
                n_tmp2 = sum(1 for value in tmp_chat[precision_column] if (value != 'NULL') and (value != "missing"))
                if n_tmp != 0 :
                    results[precision_column]["psum"] += n_tmp2/n_tmp
                    results[precision_column]["count"] += 1
