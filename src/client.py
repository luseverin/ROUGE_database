...
MODEL_NAME_LIST = ['playai-tts-arabic',
                   'allam-2-7b',
                   'qwen/qwen3-32b',
...
#retrieve max tokens
MAX_COMPLETION_TOKENS = model_table[model_table["id"] == MODEL_NAME]["max_completion_tokens"].values[0]
CONTEXT_WINDOW = model_table[model_table["id"] == MODEL_NAME]["context_window"].values[0]
